...
### Notes
  ...
  > <br><br>You can customize the keywords required in the title for a post to be fetched by modifying the `relevant_words` variable within the   `praw_reddit_custom.py` file.
